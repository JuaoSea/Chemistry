...
CLASSIFICATION_FILE = 'C:/Users/jvito/Documents/Programação/Chemistry tests/Planck_Law/data.csv'
...
class Planck:
    ...
    def plot(self, colors=plt.cm.coolwarm_r, ax=None, legend=True, **visible_kwargs):
        ...
        **visible_kwargs
        ...
        ax.set_ylabel('Densidade de energia / (' + order_magnitude +
                      ' $J/m^3$)')
        ax.set_title('Lei de Planck - Radiação do corpo negro')
